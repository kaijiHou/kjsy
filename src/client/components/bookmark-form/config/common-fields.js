...
// EasySSH 实验室字段（可选元数据，兼容 electerm 原版数据）
export const easysshLabFields = [
  {
    type: 'input',
    name: 'easysshGroup',
    label: '分组（如：训练服务器 / 开发服务器）'
  },
  {
    type: 'input',
    name: 'easysshGpuModel',
    label: 'GPU 型号（如：RTX 4090 / A100 80GB）'
  },
  {
    type: 'number',
    name: 'easysshGpuCount',
    label: 'GPU 数量'
  },
  {
    type: 'input',
    name: 'easysshDefaultRemotePath',
    label: '默认远程目录（SFTP 打开位置，如 /data）'
  }
]
